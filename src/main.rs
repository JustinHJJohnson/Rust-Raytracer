...
fn ray_color(r: Ray, world: &HittableList) -> Color {
    let result: HitResult = world.hit(&r, 0.0, 1000000.0);
    if result.hit {
...
fn main() {
    ...
    world.objects.push(Box::new(Sphere::sphere(Vec3::new(0.0, 0.0, -1.0), 0.5)));
    world.objects.push(Box::new(Sphere::sphere(Vec3::new(0.0, -100.5, -1.0), 100.0)));
